  ...
  return (
    <div
      className={`p-6 rounded-lg border-l-4 bg-white shadow-md hover:shadow-lg transition-shadow duration-200 ${
        ...
        (termin.type === 'chorprobe' || (typeof termin.type === 'string' && termin.type.startsWith('rehearsal-'))) ? 'dark:border-blue-700' :
    ...
    >
      <div className="flex items-start space-x-3">
        <div className={`p-2 rounded-full ${
          ...
          (termin.type === 'chorprobe' || (typeof termin.type === 'string' && termin.type.startsWith('rehearsal-'))) ? 'bg-blue-100 text-blue-600 dark:bg-blue-800 dark:text-blue-300' :
          ...
          <div className="flex items-center justify-between mb-1">
            ...
            <button
              ...
              className={`p-1.5 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200 ${
                ...
                (termin.type === 'chorprobe' || (typeof termin.type === 'string' && termin.type.startsWith('rehearsal-'))) ? 'text-blue-600 dark:text-blue-400' :
